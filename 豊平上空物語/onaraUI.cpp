...
// タイトルロゴの生成処理
//=============================================================================
COnaraUI *COnaraUI::Create(D3DXVECTOR3 pos, float fWidth, float fHeight, int nType)
{
	COnaraUI *pGameOverLogo = NULL;

	if (pGameOverLogo == NULL)
	{
		// タイトルロゴクラスの生成
		pGameOverLogo = new COnaraUI;
